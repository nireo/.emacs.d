;;; simple-modeline-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "simple-modeline" '("simple-modeline--mode-line")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "simple-modeline-core" '("simple-modeline-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "simple-modeline-segments" '("simple-modeline-")))
