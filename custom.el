...
(custom-set-variables
 ...
 '(package-selected-packages
   '(default-text-scale doom-themes doom-modeline moe-theme jazz-theme inkpot-theme auctex emmet-mode olivetti gruber-darker-theme apropospriate-theme diff-hl treemacs alchemist elixir-mode simplicity-theme diminish company-box dired-open dired-single yaml-mode which-key web-mode wc-mode vterm-toggle use-package typescript-mode toml-mode smartparens rustic rust-mode rainbow-delimiters prettier-js pfuture persp-mode page-break-lines org-superstar org-roam no-littering modern-cpp-font-lock memoize magit lsp-ui json-reformat hydra hl-todo go-mode flycheck evil-org evil-collection emacsql-sqlite3 docker dired-subtree dired-narrow cmake-mode cfrs all-the-icons-dired ace-window))
